...
```json
{
  "data": {
    ...
    "id": "1",
    "attributes": {
      "created_at": "2016-05-12T15:50:45Z",
      "status": "in_progress",
      "total_cents": 150000,
      "total_currency": "USD",
      "updated_at": "2016-05-12T15:50:45Z"
    },
    "relationships": {
    }
  }
...
```json
{
  "data": {
    ...
    "attributes": {
      "amount_cents": 2000,
      "amount_currency": "USD",
      "created_at": "2016-05-12T15:50:46Z",
      "fee_cents": -88,
      "fee_currency": "USD",
      "payment_brand": "Visa",
      ...
      "updated_at": "2016-05-12T15:50:46Z"
    },
    "relationships": {
    }
  }
...
```json
{
  "data": {
    ...
    "attributes": {
      ...
      "amount_currency": "USD",
      "created_at": "2016-05-12T15:50:46Z",
      "last_processed_at": "2016-05-11T00:00:00Z",
      "next_occurrence": "2016-06-11T00:00:00Z",
      "schedule": {
        "day_in_month": {
          "day": 11
        }
